...
const PackageCard = ({ title, price, code, imageSrc }) => {
  return (
        <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full ">
          <div className="flex flex-col grow px-11 py-6 w-full font-medium text-white leading-[140%] max-md:px-5 max-md:max-w-full">
            ...
            <div className="flex gap-3.5 mt-3 text-2xl max-md:pr-5">
